...
// // use  vertexs to rep opti variables(such as abc)
...
// 
// // using g2o to do curvefitting, remember vertexs are opt variables, edges are error terms
...
//   // matrix blocks(has a term in the book): 
//   //every error term opti variable is 3d, error dim is 1d
// 
// 
// 
// 
